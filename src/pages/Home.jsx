      ...
      <section style={{ position: 'relative', height: '100vh', minHeight: '850px', overflow: 'hidden' }}>
        ...
        >
          ...
          <div style={{ 
            ...
            background: 'linear-gradient(to top, rgba(255, 255, 255, 0.8) 0%, rgba(255, 255, 255, 0.3) 50%, rgba(255,255,255,0.1) 100%)' 
          }}></div>
        </motion.div>
        ...
        <div className="container" style={{ position: 'relative', height: '100%', display: 'flex', alignItems: 'center', paddingTop: '10vh' }}>
          ...
          >
            ...
            <h1 style={{ 
              ...
              lineHeight: 1.1, marginBottom: '2.5rem', fontFamily: 'var(--font-calligraphy)', color: 'var(--purple-dark)',
            ...
            <p style={{ 
              ...
              lineHeight: 2, maxWidth: '600px', fontWeight: '600', letterSpacing: '0.5px',
            ...
            <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap' }}>
              <Link to="/shop" style={{ 
                background: 'var(--primary-purple)', color: '#fff', padding: '18px 45px', 
